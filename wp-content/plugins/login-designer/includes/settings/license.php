...
$wp_customize->add_control( new Login_Designer_License_Control( $wp_customize, 'login_designer_license[key]', array(
	...
	'description'           => sprintf( esc_html__( 'Enter a %slicense key%s to enable remote updates, unlock premium templates and activate professional extensions.', 'login-designer' ), '<a href="' . esc_url( $url ) . '" target="_blank">', '</a>' ),
